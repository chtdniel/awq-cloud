/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df46adff09490271117c49a11554d5e0)
// Runtime types generated with workerd@1.20260918.1 2026-09-16 global_fetch_strictly_public
interface __BaseEnv_Env {
	DOCUMENTS: R2Bucket;
	DB: D1Database;
	VECTORIZE: VectorizeIndex;
	MINIMA_EXTRACTION_QUEUE: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	AWQ_CLOUD_BROWSER_ORIGIN: "https://awq.christiandaniel.my.id";
	AWQ_CLOUD_API_ORIGIN: "https://awq-cloud.pages.dev";
	QUERY_PLAN_DISABLED: "1";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AWQ_CLOUD_BROWSER_ORIGIN" | "AWQ_CLOUD_API_ORIGIN" | "QUERY_PLAN_DISABLED">> {}
}
